...
export default function MediaBin() {
  ...
  const handleItemDragStart = useCallback((e: React.DragEvent, item: MediaItem) => {
    ...
    dragEl.style.cssText = 'position:absolute;top:-1000px;padding:4px 10px;background:#1E293B;border:1px solid #334155;border-radius:6px;color:#F1F5F9;font-size:11px;font-family:system-ui;white-space:nowrap;';
