  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ marginTop: -2 }}
      >
        <div className="w-0 h-0 border-l-[5px] border-r-[5px] border-t-[6px] border-l-transparent border-r-transparent border-t-[#7C6BF0]" />
      </div>
      {/* Vertical line */}
      <div className="w-px bg-[#7C6BF0] ml-0 pointer-events-none" style={{ height: totalHeight }} />
    </div>
  );
}
